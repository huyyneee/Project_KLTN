        ...
        <form action="/account/update" method="POST" class="space-y-6">
          ...
          <div class="space-y-2">
            ...
            <div class="flex space-x-4">
              ...
              <label class="inline-flex items-center">
                <input type="radio" name="gender" value="other" class="text-green-600 focus:ring-green-500"
                       <?php echo $userGender === 'other' ? 'checked' : ''; ?>>
                <span class="ml-2 text-sm text-gray-700">Không xác định</span>
              </label>
            </div>
          </div>
